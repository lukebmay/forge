...
export const SETTINGS_OVERRIDES = [
  ...
  // Forge focus-right (<Super>l in vim/i3 kits). Forge locks via Super+Delete.
  ...
  // Vim/i3 Run is Super+Space. GNOME layout-switch is unused on single-layout
  // desks; restore on disable.
  {
    schemaId: "org.gnome.desktop.wm.keybindings",
