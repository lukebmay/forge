...
export const SETTINGS_OVERRIDES = [
  ...
  // forge-m37 (#249): free GNOME Super+L for Forge focus-right (vim/i3 kits).
  // Rebind GNOME's own screensaver action to Super+Delete — GNOME owns lock +
  // panel blank/DPMS; Forge must not implement lock or force xset DPMS.
  // Restored on disable(). Skip if schema/key absent (forge-rj4x).
  {
    schemaId: "org.gnome.settings-daemon.plugins.media-keys",
    key: "screensaver",
    type: "strv",
    newValue: ["<Super>Delete"],
  },
];
