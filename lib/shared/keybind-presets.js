 ...
 * Zoom (Vim/i3): Super+Space / Ctrl+Super+Space / Shift+Super+Space.
 * Float (Safe): Ctrl+Super+Space — Safe keeps Super+ free, so zoom stays unbound.
 * Float (Vim): Ctrl+Super+Return — Space is zoom.
 * Float (i3): Shift+Super+Return — Space is zoom.
 * Always-float: Ctrl+Shift+Super+Space — leftover Space twin.
 * Run (Vim/i3): Super+Return.
...
const FLOAT_SAFE = ["<Ctrl><Super>space"];
const FLOAT_VIM = ["<Ctrl><Super>Return"];
const FLOAT_I3 = ["<Shift><Super>Return"];
const ALWAYS_FLOAT = ["<Ctrl><Shift><Super>space"];
const ZOOM_FULL = ["<Super>space"];
const ZOOM_H = ["<Ctrl><Super>space"];
const ZOOM_V = ["<Shift><Super>space"];
const RUN_ENTER = ["<Super>Return"];
