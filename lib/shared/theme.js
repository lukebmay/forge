...
export class ThemeManagerBase extends GObject.Object {
  ...
  getDefaultPalette() {
    return {
      ...
      selection: this.getDefaults("selection"),
    };
  }
  ...
  _getStylesheetFile() {
    // Prefer user profile stylesheet when present. make dev flips production=false
    // for logging; that must not force the bundled default and hide custom colors.
