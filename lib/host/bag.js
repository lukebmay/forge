 ...
 * @property {object} [border] St focus border for WINDOW (D096 G5)
 * @property {object} [decoration] CON tab/stack strip host (G5c)
 * @property {object} [tabStrip] CON tab strip alias (G5c)
 * @property {object} [tab] WINDOW/CON tab chip actor (G8b)
 * @property {object} [tabChip] WINDOW/CON tab chip alias (G8b)
 * @property {{ x: number, y: number, width: number, height: number }|null} [desiredRect] projected slot AABB
 * @property {{ x: number, y: number, width: number, height: number }|null} [commanded] last move_resize sent
 * @property {{ x: number, y: number, width: number, height: number }|null} [observed] last presenter frame
 * @property {number} [slotGen] bumps when desiredRect changes
 * @property {object[]|null} [healTrail] heal decision stub (S5+)
 */
