...
/** TEMP: required TILE slot stays FLOAT / wrong Meta mon (vinyl WS2). Off — hunt closed. */
export const HUNT_TILE_SLOT_FLOAT = false;

/** TEMP: TRACE every unchanged processFloats keep (off — title churn spam). */
export const HUNT_FLOAT_REASON_KEEP = false;
