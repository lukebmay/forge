...
export class WindowManager extends GObject.Object {
   ...
   *
   * Apply chrome stays until clearLayoutApplyChrome() — CLI clears after end
   * (before residual place). end() itself does not clear chrome.
   * @param {string} [reason]
   */
  endOpenLayoutBatch(reason) {
    ...
    // Depth 0: do not clear apply chrome here (CLI chrome-clear after end).
