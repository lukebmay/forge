...
export class WindowManager extends GObject.Object {
  ...
  trackWindow(_display, metaWindow) {
    ...
    if (this._validWindow(metaWindow)) {
      ...
      if (!existNodeWindow) {
        ...
        // D032 slot-split + optional 1-child auto-split. CL8: skip mid-batch.
        ...
        // Bag: sibling of the bag (wrap CON). createNode(bag) would append a tab.
        const attachTarget =
  ...
  _orientationFromUnit(unit) {
    ...
    const rect =
      (typeof meta?.get_frame_rect === "function" ? meta.get_frame_rect() : null) || unit.rect;
