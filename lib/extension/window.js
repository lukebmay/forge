...
export class WindowManager extends GObject.Object {
  ...
  _softRehomeAfterWorkareas() {
    ...
    // Capture before rehome; restore only unwrapped groups after reconcile.
    ...
    if (!structureOk) {
      Logger.debug("soft-rehome: tree inconsistent, reloadTree + layout groups");
    ...
    this.tree.restoreLayoutGroupsIfUnwrapped(layoutGroups);
