 ...
 * - Clear when opens/map-pins settle and LayoutBatch ends (before residual
 *   place/structure). Residual rehome does not need the overlay.
 * - CLI still issues chrome-clear after end; finally clears if not already.
 ...
 * Multi-open on dual 4K can exceed 8s; residual no longer keeps chrome up.
 */
