 ...
 * - ApplyLayout clears after soft settle (before verify/belt) so tabs are usable
 *   once focus residual is quiet; terminal Done still clears on error/early exit.
 * - Batch end does not clear — soft/focus is the “do not touch” phase.
