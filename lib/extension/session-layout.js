...
/**
 * Pin TABBED/STACKED open leaf from live keyboard focus before session snapshot.
 * `focus-update` can lag Mutter; install flush must not write a stale lastTabFocus.
 *
