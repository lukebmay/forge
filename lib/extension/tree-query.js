 ...
 *
 * Pure tree → JSON projection for DBus GetTree / CLI (FC0).
 ...
 * @param {any} nodeValue
 * @returns {{ id?: number|string|null, wmClass: string|null, title: string|null }}
 */
export function windowMetaFields(nodeValue) {
  const out = { wmClass: null, title: null, id: null };
...
/**
 * Project MONITOR nodes to a forest JSON document.
 ...
 * }} [options]
 * @returns {{ apiVersion: number, monitors: object[] }}
 */
