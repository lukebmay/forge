...
export class WorkspaceManager extends GObject.Object {
  ...
  addWorkspace(wsIndex) {
    ...
    forestEnsureSpineNode(this._extWm, newWsNode);
  ...
  bindWorkspaceSignals(metaWorkspace) {
    ...
    const signals = [
      metaWorkspace.connect("window-added", (_, metaWindow) => {
        ...
        // Slot auto-clears on fire (SourceBag); throw cannot wedge the guard.
        if (!this._extWm._wmSources.has("wsWindowAdd")) {
          this._extWm._wmSources.set("wsWindowAdd", 200, () => {
