  ...
  buildBindingDefinitions() {
    this._bindings = {
      ...
      ...this._simpleCommandBindings({
        ...
        "con-stack-tab-layout-toggle": { name: "LayoutStackTabToggle" },
        "window-merge-group": { name: "WindowMergeGroup" },
        "window-ungroup": { name: "WindowUngroup" },
        "window-focus-parent": { name: "focus.parent" },
        "window-focus-child": { name: "focus.child" },
