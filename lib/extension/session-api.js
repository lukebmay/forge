 ...
 * ApplyLayout / GetLayoutApply / CancelLayoutApply (AL4, D038).
 */
...
export class SessionApi {
   ...
   * AL4 stub walks phases; AL5+ runs real structure/open/settle.
  ...
  _ensureLayoutApplyRuns() {
    ...
    this._layoutApplyRuns = new LayoutApplyRunBag({
      ...
      onDone: (payload) => this._emitLayoutApplySignal("LayoutApplyDone", payload),
