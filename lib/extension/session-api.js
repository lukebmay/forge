...
export class SessionApi {
  ...
  _layoutOp(mode, selector, opts = {}) {
    ...
    if (isTabOrStack) {
      // Preserve open leaf when re-affirming TABBED/STACKED (belt ensure uses
      // first windowId as selector = chrome; profile active is often Grok).
      // Only set lastTabFocus from selector when missing or no longer a child.
