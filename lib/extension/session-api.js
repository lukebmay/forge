 ...
 *
 * Session DBus API: Ping, GetTree, Focus, Swap, Move (FC0–FC1).
 */
...
/** Combined control-plane version (selectors + Focus/Swap/Move). */
export const SESSION_API_VERSION = TILE_SELECT_API_VERSION;
