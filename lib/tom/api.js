...
export function createTomApi() {
  ...
  const api = {
    ...
    inventConUnder(f, parentNode, layout) {
      return inventConUnder(f, parentNode, layout);
    },
    inventWindowUnder(f, parentNode, label, wmClass) {
      return inventWindowUnder(f, parentNode, label, wmClass);
    },
    ...
    layoutUnit(f, n) {
      return layoutUnit(f, n);
    },
    monDirectAncestor(f, n) {
      return monDirectAncestor(f, n);
    },
    siblingCon(f, n) {
      return siblingCon(f, n);
    },
    unwrapUnarySplit(f, n) {
      return unwrapUnarySplit(f, n);
    },
  };
