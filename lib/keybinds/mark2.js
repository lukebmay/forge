// @ts-check
/**
 * Super-bearing Mark 2 kit. Proto = stripSuper(this ∪ WebView overlay).
 */
...
export const MARK2_TABLE = Object.freeze({
  ...
  "size.share": "<Alt><Super>y",
  "size.shareSiblings": "<Alt><Super>u",
  "size.shareSiblingsOnly": "<Alt><Super>i",
  "size.shareSelfSiblingsParent": "<Alt><Super>o",
  "size.shareParent": "<Alt><Super>n",
  "size.shareParentGroup": "<Alt><Super>m",
  "size.shareParentSiblingsOnly": "<Alt><Super>comma",
  "size.shareBothGroups": "<Alt><Super>period",
  "size.shareAll": "<Alt><Super>slash",
