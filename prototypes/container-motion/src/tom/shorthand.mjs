...
import { createTomApi } from "./api.mjs";
...
/** @typedef {import('./api.mjs').TomApi} TomApi */
...
export function buildGiven(given, prefs = {}) {
  ...
  f.decisions.edgeMove = /** @type {any} */ (prefs.edgeMove || "wrap");
  f.decisions._edgeNoopMigrated = true;
  if (prefs.policyEnabled != null) f.decisions.policyEnabled = prefs.policyEnabled;
  if (prefs.opsetId) f.decisions.opsetId = prefs.opsetId;
