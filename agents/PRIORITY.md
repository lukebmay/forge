...
**Updated:** 2026-08-06 (AP1 done; AP2 next; X11 mon-order filed)  
...
| Order | ID | Task | Why |
| ---: | --- | --- | --- |
| **1** | **AP2** | Move/Swap/drag one Commit | [action-pipeline](./plans/forge-action-pipeline.md) |
| **2** | **AP3** | Geom/open/RunSteps formula alignment | same plan |
...
| Pri | Item | Status |
| --- | --- | --- |
| **P0** | [action pipeline](./plans/forge-action-pipeline.md) | **AP1 done; AP2 next** |
