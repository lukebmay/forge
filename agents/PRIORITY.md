...
| Order | ID | Task | Why |
| ---: | --- | --- | --- |
| **1** | **stacks** | STACKED product path — SL3 done; **next SL4** optional regression | [forge-stacked-layouts.md](./plans/forge-stacked-layouts.md) |
...
| Pri | Item | Status |
| --- | --- | --- |
| **P0** | [stacked](./plans/forge-stacked-layouts.md) | SL3 **done** — next **SL4** optional / SL5 live |
