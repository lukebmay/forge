...
| Order | ID | Task | Why |
| ---: | --- | --- | --- |
| **1** | **containers** | First-class CONs (+ resize); zoom/float later | [forge-first-class-containers.md](./plans/forge-first-class-containers.md) — **C0–C1 done**; next **C2** / **R1** |
...
| P0 | [first-class containers](./plans/forge-first-class-containers.md) | **C0–C1 done** (I1 layout toggles); next **C2** group/ungroup + **R1** resize |
