...
1. yuiop / ratio-resize semantics (relative vs absolute vs snap targets)
2. Mod chord that does not break Safe kit edge y/u/i/o
3. CLI verb names (`forge size` vs `forge resize`)
4. Auto-tile shortlist (1–2 algorithms for first spike)
...
Created as discussion placeholder; do not implement in this task.
