...
**AP1–AP2 done:** afterFocus + structure one-commit  
**Next:** AP3 geom/open/RunSteps  
...
| **Action pipeline AP0–AP2** | **Done** |
| **AP3 geom/open/RunSteps** | **Next** |
| AP4 command facade | After AP3 |
| AP5 live X11 HUP smoke | After AP2/AP3 (operator) |
