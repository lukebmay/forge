...
| R008 | 2026-08-09 | **true cold** mon0 Chrome New Tab over Grok (partial path green) | TBD — SE8b debug (soft/pin/post-settled vs residual settle stomp) | open | [SE8b](./tasks/forge-layout-settle-contract_se8-true-cold-open-leaf.md) |
| R009 | 2026-08-09 | `forge layout clean` / show fails on `{tiles:[]}` | `detect_layout_mode` requires non-empty tiles | open | [CE1](./tasks/forge-layout-clean-empty_ce1-detect.md) |
