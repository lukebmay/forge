...
| ID | Task | Status |
| --- | --- | --- |
| FC0 | [Design lock + pure focus-target helper](../tasks/forge-focus-close-and-escape_fc0-policy.md) | ready |
| FC1 | [Wire close restore to policy](../tasks/forge-focus-close-and-escape_fc1-close-restore.md) | next |
