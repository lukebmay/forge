...
| D025 | 2026-08-13 | focus | P0 | active | Live show-in-group via one WM helper (`revealGroupChild`); snapshot may write `lastTabFocus` as data only; reveal reasserts that child to slot (R025) | Agents re-coded LTF+raise; tab strip / pin / activate drifted; hidden tab stayed FLOAT/old-slot |
