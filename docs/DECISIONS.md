...
| D025 | 2026-08-13 | focus | P0 | active | Live show-in-group via one WM helper (`revealGroupChild`); snapshot may write `lastTabFocus` as data only | Agents re-coded LTF+raise; tab strip / pin / activate drifted |
